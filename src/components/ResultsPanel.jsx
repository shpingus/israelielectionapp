...
export default function ResultsPanel({ scores, answers, questions, parties, onRetake, onViewParties }) {
  ...
  return (
    <div className="slide-in-up" style={{ width: '100%', maxWidth: '800px', margin: '20px auto 40px auto' }}>
      ...
      >
        <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '16px', textAlign: 'center' }}>
          {t('detailedBreakdown')} ({comparedPartyName})
        </h3>

        {/* Dynamic party comparison selector dropdown */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '28px', flexWrap: 'wrap' }}>
          <span className="monospace-label" style={{ fontWeight: 800, fontSize: '0.9rem' }}>{t('compareWith')}</span>
          <select
