...
const translations = {
  ...
  he: {
    ...
    considerVotingQuestion: "האם זו המפלגה ששקלת להצביע לה?",
    yes: "כן",
    no: "לא",
    maybe: "אולי / לא בטוח",
    feedbackReceived: "תודה על המשוב!",
    adminDashboard: "לוח בקרה מנהל",
    adminTokenPrompt: "הזן מפתח גישה למנהל מערכת",
    adminTokenPlaceholder: "הזן מפתח גישה...",
    submitToken: "אשר גישה",
    invalidToken: "מפתח הגישה שגוי או לא מורשה.",
    sqlQueryPlaceholder: "הזן שאילתת SQL לקריאה (לדוגמה SELECT * FROM sessions;)",
    runQuery: "הרץ שאילתה",
